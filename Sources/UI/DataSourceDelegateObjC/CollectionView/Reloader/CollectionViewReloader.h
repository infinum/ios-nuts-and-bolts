...
- (void)reloadCollectionView:(UICollectionView*)collectionView oldSections:(NSArray<id<CollectionSectionItem>> *)oldSections newSections:(NSArray<id<CollectionSectionItem>> *)newSections;
