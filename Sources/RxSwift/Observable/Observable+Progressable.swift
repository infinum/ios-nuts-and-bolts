...
public extension ObservableType {
    ...
    public func handleShowLoading(with progressable: Progressable) -> Observable<E> {
        return self
            .do(onSubscribe: { [unowned progressable] in progressable.showLoading() })
    }
    
    /// Hides loading on next event or error event.
    public func handleHideLoading(with progressable: Progressable) -> Observable<E> {
        return self
    ...
    public func handleLoading(with progressable: Progressable) -> Observable<E> {
        return self
    ...
    public func handleShowFailure(with progressable: Progressable) -> Observable<E> {
        return self
    ...
    public func handleLoadingAndError(with progressable: Progressable) -> Observable<E> {
        return self
