...
public extension PrimitiveSequenceType where TraitType == SingleTrait {
    ...
    func handleShowLoading(with progressable: Progressable) -> Single<ElementType> {
        return self
            .do(onSubscribe: { [unowned progressable] in progressable.showLoading() })
    }
    
    /// Hides loading on success event or error event.
    func handleHideLoading(with progressable: Progressable) -> Single<ElementType> {
        return self
    ...
    func handleLoading(with progressable: Progressable) -> Single<ElementType> {
        return self
    ...
    func handleShowFailure(with progressable: Progressable) -> Single<ElementType> {
        return self
    ...
    func handleLoadingAndError(with progressable: Progressable) -> Single<ElementType> {
        return self
